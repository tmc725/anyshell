...
sys.path.append(os.environ["SHELLBASE"]+'/shell')
import inspect
...
#c.InteractiveShell.banner1 = 'Python 2.7.12 (default, Sep 29 2016, 12:52:02) \nType "copyright", "credits" or "license" for more information.\n\nIPython 5.2.1 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
from shell_version import shell_version
normalized_version = shell_version
#normalized_version = '.'.join(shell_version.split('.')[:-1])

banner = '''
Anyshell %s

All other trademarks used herein are the property of Ta-Ming Chen
